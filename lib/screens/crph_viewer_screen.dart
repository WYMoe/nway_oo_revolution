...
class CRPHViewerScreen extends StatefulWidget {
  ...
  CRPHViewerScreen(
      ...
      this.time});
  @override
  _CRPHViewerScreenState createState() => _CRPHViewerScreenState(
      time: time,
      title: title,
      photo: photo,
      dateTime: dateTime,
...
class _CRPHViewerScreenState extends State<CRPHViewerScreen> {
  final String provelink;
  final String date;
  final Timestamp dateTime;
  final String detail;
