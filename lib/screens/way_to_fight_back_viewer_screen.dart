...
class WayToFightBackViewerScreen extends StatefulWidget {
  final List<dynamic> photo;
  final String title;
  final String detail;
  WayToFightBackViewerScreen(this.photo, this.title, this.detail);
  @override
  _WayToFightBackViewerScreenState createState() =>
      _WayToFightBackViewerScreenState(
          title: title, photo: photo, detail: detail);
}

class _WayToFightBackViewerScreenState extends State<WayToFightBackViewerScreen> {

  List<dynamic> photo = [];
  final String title;
  final String detail;

  _WayToFightBackViewerScreenState({ this.photo, this.title,this.detail});
